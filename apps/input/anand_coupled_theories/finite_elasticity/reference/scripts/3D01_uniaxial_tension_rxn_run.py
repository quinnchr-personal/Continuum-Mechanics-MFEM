...
# %% ----
# results file name
results_name = "3D01_uniaxial_tension_rxn_3D_uniaxial_tension"
...
if MPI.COMM_WORLD.rank == 0:
    ...
    _np.savetxt("hist/3D01_uniaxial_tension_rxn.csv", _np.column_stack([v[:_n] for v in _h.values()]), delimiter=",", header=",".join(_h), comments="")
