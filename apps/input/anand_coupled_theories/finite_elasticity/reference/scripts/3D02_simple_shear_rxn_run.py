...
# %% ----
# results file name
results_name = "3D02_simple_shear_rxn_3D_simple_shear"
...
if MPI.COMM_WORLD.rank == 0:
    ...
    _np.savetxt("hist/3D02_simple_shear_rxn.csv", _np.column_stack([v[:_n] for v in _h.values()]), delimiter=",", header=",".join(_h), comments="")
