...
Without inputs every apps/input/finite_elasticity/homogeneous_deformations/*.yaml is run: plane-strain
...
def main():
    ...
    args = ap.parse_args()
    inputs = args.inputs or sorted(glob.glob("apps/input/finite_elasticity/homogeneous_deformations/*.yaml"))
    if not inputs:
