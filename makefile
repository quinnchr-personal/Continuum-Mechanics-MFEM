...
test: check $(APP) $(BUILD_DIR)/tests/test_benchmarks $(BUILD_DIR)/tests/test_parallel
	$(APP) -i apps/input/finite_elasticity/cook.yaml
	$(MFEM_MPIEXEC) -np 4 $(APP) -i apps/input/finite_elasticity/cook.yaml
	...
	$(APP) -i apps/input/finite_elasticity/cook_incompressible.yaml
	$(MFEM_MPIEXEC) -np 4 $(APP) -i apps/input/finite_elasticity/cook_incompressible.yaml
	python3 apps/homogeneous_compare.py --app $(APP)
