...
// membrane (apps/input/finite_elasticity/cook/cook_incompressible.yaml, mu = 80.194, resultant 100)
...
{
  cmf::AppConfig cfg = cmf::LoadConfig("apps/input/finite_elasticity/cook/cook_incompressible.yaml");
