...
// membrane (apps/input/finite_elasticity/cooks_membrane/cook_incompressible.yaml, mu = 80.194, resultant 100)
...
{
  cmf::AppConfig cfg = cmf::LoadConfig("apps/input/finite_elasticity/cooks_membrane/cook_incompressible.yaml");
...
{
  cmf::AppConfig cfg = cmf::LoadConfig("apps/input/finite_elasticity/cooks_membrane/cook.yaml");
  cfg.output.paraview.clear();
  cfg.solver.newton.print_level = 0;
  cfg.solver.newton.rtol = 1e-11;
  cfg.solver.linear.rtol = 1e-13;
...
void CantileverTest()
{
  cmf::AppConfig cfg = cmf::LoadConfig("apps/input/finite_elasticity/verification/euler_bernoulli_cantilever3d.yaml");
  cfg.output.paraview.clear();
  cfg.solver.newton.print_level = 0;
  cfg.solver.linear.rtol = 1e-13;
